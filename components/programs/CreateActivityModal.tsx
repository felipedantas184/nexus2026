        ...
        <Form onSubmit={handleSubmit}>
          ...
          {selectedType === 'quiz' && (
            <Section>
              ...
              <HelpText>
                As questões serão adicionadas após a criação da atividade.
              </HelpText>
            </Section>
          )}
          ...
          {selectedType === 'habit' && (
            <Section>
              ...
              <InputGroup>
                ...
                <Select id="frequency" defaultValue="daily">
...
// Estilos (reutilizando muitos do modal anterior e adicionando novos)
...
// Reutilizar estilos do modal anterior
